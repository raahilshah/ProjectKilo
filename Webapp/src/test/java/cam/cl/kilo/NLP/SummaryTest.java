...
public class SummaryTest {
    ...
    public void testStringToArrayList1() throws Exception {
        ...
        assertEquals(new ArrayList<String>(Arrays.asList(post1)), Summary.stringToArrayList(pre1));
        assertEquals(new ArrayList<String>(Arrays.asList(post2)), Summary.stringToArrayList(pre2));
    }
